...
class GameScene: SKScene {
    ...
    func createFirework(xMovement: CGFloat, x: Int, y: Int) {
        ...
        // 2 - Create a rocket sprite node, give it the name "firework", adjust its colorBlendFactor property so that we can color it, add it to the container node.
    ...
    func checkTouches(_ touches: Set<UITouch>) {
        ...
        //The let node part creates a new constant called node, the case…as SKSpriteNode part means “if we can typecast this item as a sprite node,
   ...
   override func update(_ currentTime: TimeInterval) {
        ...
        //Count backwards through the array as we are removing items from it, enumerate so we can remove at specific index
